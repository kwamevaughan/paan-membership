...
export default function OpportunityForm({
  ...
  return (
    <form
      onSubmit={submitForm}
      className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl overflow-hidden border-0"
    >
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-6">
        ...
        <p className="mt-1 text-indigo-100 text-sm">
          {isEditing
            ? "Update the details of this business opportunity"
            : "Fill out the form to create a new business opportunity"}
        </p>
      </div>
