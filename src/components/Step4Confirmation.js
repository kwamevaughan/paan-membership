...
export default function Step4Confirmation({
  ...
  // Function to render the timeline step
      ...
      >
        ...
        <div className="text-center py-8 px-6 border-b border-gray-200">
          ...
          <h2 className={`text-3xl font-bold mb-3 ${textColor}`}>
            {submissionStatus.success
              ? `Thank You, ${formData.primaryContactName}!`
              : "Submission Failed"}
          </h2>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <p className={`text-sm ${subTextColor}`}>
                    PAAN prioritizes agencies committed to ethical practices,
                    innovation, and pan-African collaboration. All information
