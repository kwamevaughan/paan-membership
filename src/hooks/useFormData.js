  ...
  const handleSubmit = async () => {
    try {
      ...
      const nonFileData = {
        ...
        secondaryContactName: cleanedFormData.secondaryContactName,
        secondaryContactRole: cleanedFormData.secondaryContactRole,
        secondaryContactEmail: cleanedFormData.secondaryContactEmail,
        secondaryContactPhone: cleanedFormData.secondaryContactPhone,
