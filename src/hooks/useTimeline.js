      ...
      const tables = [
        {
          ...
          select:
            "id, organization_name, tender_title, gig_title, description, locations, deadline, tier_restriction, service_type, industry, project_type, application_link, created_at, updated_at, is_tender",
