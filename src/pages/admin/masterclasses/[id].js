...
export default function MasterclassDetail({ mode = "light", toggleMode }) {
  ...
  const fetchRegistrations = useCallback(async () => {
    ...
    try {
      const response = await fetch(`/api/masterclasses/registrations?masterclass_id=${id}`);
      const result = await response.json();
  ...
  const fetchPayments = useCallback(async () => {
    ...
    try {
      const response = await fetch(`/api/masterclasses/payments?masterclass_id=${id}`);
      const result = await response.json();
  ...
  const updateRegistrationStatus = async (registrationId, newStatus) => {
    try {
      ...
      if (response.ok) {
        ...
        const result = await response.json();
        alert(result.error || 'Error updating registration status');
      }
    } catch (error) {
  ...
  const handleEdit = async (masterclassData) => {
    try {
      ...
      if (response.ok) {
        ...
        alert(result.error || 'Error updating masterclass');
      }
    } catch (error) {
      console.error('Error updating masterclass:', error);
      alert('Error updating masterclass');
    }
  };
    ...
    return (
      <div className={`min-h-screen flex items-center justify-center ${
        ...
        <div className="text-center">
          <Icon icon="heroicons:exclamation-triangle" className="w-12 h-12 mx-auto text-gray-400" />
          <p className={`mt-2 ${mode === "dark" ? "text-gray-400" : "text-gray-500"}`}>
                ...
                stats={[
                  {
                    ...
                    value: `${masterclass.max_seats - masterclass.available_seats}/${masterclass.max_seats} enrolled`,
                  },
                  {
                    ...
                    <div className={`border-b ${mode === "dark" ? "border-gray-700" : "border-gray-200"}`}>
                      <nav className="flex space-x-8 px-6">
                        {[
                          ...
                          { id: 'registrations', label: 'Registrations', icon: 'heroicons:users' },
                    ...
                    <div className="p-6">
                        ...
                        <div>
                          ...
                          {registrations.length === 0 ? (
                            <div className="text-center py-8">
                              <Icon icon="heroicons:users" className="w-12 h-12 mx-auto text-gray-400" />
                              <p className={`mt-2 ${mode === "dark" ? "text-gray-400" : "text-gray-500"}`}>
                                        ...
                                        <div className="flex items-center">
                                          ...
                                          <div className="ml-3">
                                            <div className={`text-sm font-medium ${
                                              ...
                                              {registration.member?.name || 'Unknown Member'}
                                            </div>
                      ...
                      {activeTab === 'payments' && (
                        <div>
                          <div className="flex items-center justify-between mb-6">
                            ...
                            <div className="flex items-center space-x-4">
                              <span className={`text-sm ${
                                ...
                                Total Revenue: ${payments.reduce((sum, p) => sum + (p.amount || 0), 0)}
                              </span>
                            </div>
                          </div>
                          ...
                          {payments.length === 0 ? (
                            <div className="text-center py-8">
                              <Icon icon="heroicons:credit-card" className="w-12 h-12 mx-auto text-gray-400" />
                              <p className={`mt-2 ${mode === "dark" ? "text-gray-400" : "text-gray-500"}`}>
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                            <div className={`p-4 rounded-lg ${
                              ...
                              <div className="flex items-center">
                                <Icon icon="heroicons:users" className="w-8 h-8 text-blue-500" />
                                <div className="ml-3">
                                  ...
                                  <p className={`text-2xl font-semibold ${
                                    ...
                                    {masterclass.max_seats - masterclass.available_seats}
                                  </p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className={`p-4 rounded-lg ${
                              ...
                              <div className="flex items-center">
                                <Icon icon="heroicons:chart-bar" className="w-8 h-8 text-purple-500" />
                                <div className="ml-3">
                                  <p className={`text-sm font-medium ${
                                    mode === "dark" ? "text-gray-400" : "text-gray-600"
                                  }`}>
                                  ...
                                  <p className={`text-2xl font-semibold ${
                                    ...
                                    {Math.round(((masterclass.max_seats - masterclass.available_seats) / masterclass.max_seats) * 100)}%
                                  </p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className={`p-4 rounded-lg ${
                              ...
                              <div className="flex items-center">
                                <Icon icon="heroicons:check-circle" className="w-8 h-8 text-emerald-500" />
                                <div className="ml-3">
                                  <p className={`text-sm font-medium ${
                                    mode === "dark" ? "text-gray-400" : "text-gray-600"
                                  }`}>
                                ...
                                <div key={registration.id} className="flex items-center space-x-4">
                                  ...
                                  <div className="flex-1">
                                    <p className={`text-sm font-medium ${
                                      ...
                                      {registration.member?.name || 'Unknown Member'} registered
                                    </p>
                                    <p className={`text-xs ${
                                      mode === "dark" ? "text-gray-400" : "text-gray-500"
                                    }`}>
                        ...
                        <div className="pt-2">
                          ...
                          <div className={`w-full bg-gray-200 rounded-full h-2 ${
                            ...
                            <div
                              ...
                              style={{
                                width: `${((masterclass.max_seats - masterclass.available_seats) / masterclass.max_seats) * 100}%`
                              }}
                            ></div>
                          </div>
                        </div>
        ...
        >
          <div className="space-y-6">
            ...
            >
              ...
              <strong>&quot;{masterclass?.title}&quot;</strong>? This action cannot be undone.
            </p>
