...
export default function HRInterviewQuestions({
  ...
  const startEditing = (question) => {
    console.log("startEditing called with question:", question); // Debug
    ...
    console.log("Normalized question for editing:", normalizedQuestion); // Debug
    setEditingQuestion(normalizedQuestion);
    setIsQuestionModalOpen(true, () => {
      console.log("isQuestionModalOpen updated:", true); // Debug
    });
  };

  const handleAddQuestion = () => {
    console.log("Opening form for new question"); // Debug
    setEditingQuestion(null);
    setIsQuestionModalOpen(true);
  };

  const handleFormCancel = () => {
    console.log("Form cancelled, closing modal"); // Debug
...
export async function getServerSideProps(context) {
  ...
  try {
    ...
    // Normalize questions to ensure category is a string ID
