...
export default function HROverview({
  ...
  initialJobOpenings,
  initialQuestions,
  breadcrumbs, // New prop for breadcrumbs
}) {
  ...
  return (
    ...
    >
      ...
      <HRHeader
        ...
        breadcrumbs={breadcrumbs} // Pass breadcrumbs to HRHeader
      />
      <div className="flex flex-1">
        ...
        />
        <div
          className={`content-container flex-1 p-10 transition-all duration-300 overflow-hidden ${
